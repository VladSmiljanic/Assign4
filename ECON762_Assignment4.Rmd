...
Sensitivity curve displays whether an estimator is bounded when an outlier is inputted into the sample data. The outlier can be an arbitrary number within a range of $\pm \infty$ and will help us determine the robustness of an estimator. An unbounded sensitivity curve is undesired as it results in a non-robust estimator.
